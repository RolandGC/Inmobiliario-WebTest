...
const Layout = () => {
    ...
    return (
        <div>
            <div className={
                !isMenuOpen
                    ? "flex fixed items-center w-full px-4 justify-around bg-slate-200"
                    : "flex fixed flex-col w-full px-4 justify-around bg-slate-200"
            }>
                ...
                </Link>
                {
                    windowDimension.innerWidth > 768 ?
                        links.map((l) => (
                            <Link className="text-xl text-blue-900 font-semibold" to={l.link} key={l.id}>{l.text}</Link>
                        )) :
                        isMenuOpen &&
                        links.map((l) => (
                            <Link className="text-xl text-blue-900 font-semibold" to={l.link} key={l.id}>{l.text}</Link>
            ...
            <footer class="bg-slate-200">
                <div className="container mx-auto p-2 flex justify">
                    <nav>
                        <span>© Copyright 2024 pazhogar.pe</span>
                    </nav>
                </div>
            </footer>
        </div>
